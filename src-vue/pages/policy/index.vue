        ...
        <div class="row justify-content-center">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <p>
                  At Code Matter Studio, accessible from
                  https://codematter.studio/, one of our main priorities is the
                  privacy of our visitors. This Privacy Policy document contains
                  types of information that is collected and recorded by Code
                  Matter Studio and how we use it.
                </p>
                ...
                <p>
                  ...
                  information that they shared and/or collect in Code Matter
                  Studio. This policy is not applicable to any information
                  collected offline or via channels other than this website.
                </p>

                <h6 class="p-15px-t">Consent</h6>
                ...
                <h6 class="p-15px-t">Information we collect</h6>
                ...
                <h6 class="p-15px-t">How we use your information</h6>
                ...
                <h6 class="p-15px-t">Log Files</h6>

                <p>
                  Code Matter Studio follows a standard procedure of using log
                ...
                <h6 class="p-15px-t">Cookies and Web Beacons</h6>

                <p>
                  Like any other website, Code Matter Studio uses 'cookies'.
                ...
                <h6 class="p-15px-t">Google DoubleClick DART Cookie</h6>
                ...
                <h6 class="p-15px-t">Advertising Partners Privacy Policies</h6>

                <p>
                  You may consult this list to find the Privacy Policy for each
                  of the advertising partners of Code Matter Studio.
                </p>

                <p>
                  Third-party ad servers or ad networks uses technologies like
                  cookies, JavaScript, or Web Beacons that are used in their
                  respective advertisements and links that appear on Code Matter
                  Studio, which are sent directly to users' browser. They
                ...
                <p>
                  Note that Code Matter Studio has no access to or control over
                  these cookies that are used by third-party advertisers.
                </p>

                <h6 class="p-15px-t">Third Party Privacy Policies</h6>

                <p>
                  Code Matter Studio's Privacy Policy does not apply to other
                ...
                <h6 class="p-15px-t">GDPR Data Protection Rights</h6>
                ...
                <h6 class="p-15px-t">Children's Information</h6>
                ...
                <p>
                  Code Matter Studio does not knowingly collect any Personal
